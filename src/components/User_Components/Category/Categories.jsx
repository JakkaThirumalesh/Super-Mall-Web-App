...
export const Categories = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(category_name || "All");
  ...
  const getShops = async () => {
    ...
    const uniqueCategories = [...new Set(filteredData.map(shop => shop.category))];
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="w-fit relative">
            ...
            >
              More Options
              <svg
                className={`w-2.5 h-2.5 ms-3 ${isOpen ? "rotate-180" : "rotate-0"
                  }`}
                aria-hidden="true"
          ...
          <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr className="text-center">
                <th scope="col" className="py-3 px-6 whitespace-nowrap">SN.</th>
                <th scope="col" className="py-3 px-6 whitespace-nowrap">Shop ID</th>
                <th scope="col" className="py-3 px-6 whitespace-nowrap">Shop Name</th>
                <th scope="col" className="py-3 px-6 whitespace-nowrap">Category</th>
                <th scope="col" className="py-3 px-6 whitespace-nowrap">Owner</th>
                <th scope="col" className="py-3 px-6 whitespace-nowrap">Action</th>
              </tr>
            </thead>
            <tbody>
              {filteredShops.map((shop, index) => (
                <tr key={shop.id} className="border-b dark:bg-gray-800 text-center dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <td className="py-4 px-6 whitespace-nowrap">{index + 1}</td>
                  <td className="py-4 px-6 whitespace-nowrap">{shop.shopId}</td>
                  <td className="py-4 px-6 whitespace-nowrap">{shop.shopName}</td>
                  <td className="py-4 px-6 whitespace-nowrap">{shop.category}</td>
                  <td className="py-4 px-6 whitespace-nowrap">{shop.ownerDetails.ownerName}</td>
